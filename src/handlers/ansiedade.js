...
module.exports = {
    ...
    async handle({ msg, parsed }) {
        ...
        if (value === null) {
            console.log("[ANSIEDADE] Valor invalido (0-10). Recebido:", parsed.args);
            return;
        }
        return await metricService.saveMetric({ metric: "ansiedade", value, timestamp: msg.timestamp, rawArgs: parsed, options: { force } });
    },
};
